...
// Motorcycle silhouette component
...
export default function SagCalculatorPage() {
  ...
  // Calculate recommended preload adjustment
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="h-10 w-20 bg-background-elevated text-right font-mono tabular-nums"
                  />
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    placeholder="—"
                    className="h-10 w-20 bg-background-elevated text-right font-mono tabular-nums placeholder:text-foreground-muted"
                  />
                  <span className="text-sm text-foreground-muted">mm</span>
                </div>
              </div>
          ...
          {preloadRecommendation && (
            <section className="rounded-lg border border-accent-orange/30 bg-accent-orange/10 p-4">
              <p className="text-sm text-foreground">
                Free sag is <span className="font-mono font-semibold">{freeSag}mm</span> — target is {freeSagTarget.min}-{freeSagTarget.max}mm.
              </p>
              ...
              <p className="mt-1 text-xs text-foreground-muted">
                (Current: {preloadRecommendation.current} turns → Recommended: {preloadRecommendation.recommended} turns)
              </p>
            </section>
          )}
