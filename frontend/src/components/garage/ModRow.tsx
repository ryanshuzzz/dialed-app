...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  ecu: 'bg-amber-100 text-amber-800',
  lighting: 'bg-cyan-100 text-cyan-800',
  drivetrain: 'bg-teal-100 text-teal-800',
  ergonomics: 'bg-lime-100 text-lime-800',
  wheels_tires: 'bg-indigo-100 text-indigo-800',
